        ...
        for (KeywordInterface inst : keywords) {
            ...
            if (keyword.startsWith("CantBeCounteredBy")) {
                ...
                sbLong.append("Partner with " + k[1] + " (" + inst.getReminderText() + ")");
                    ...
                    || keyword.startsWith("Graft") || keyword.startsWith("Fading") || keyword.startsWith("Vanishing") || keyword.startsWith("Poisonous")
                ...
                sb.append(")");
                     ...
                     || keyword.startsWith ("Afflict") || keyword.startsWith ("Rampage") || keyword.startsWith("Cascade")) {
                if (sb.length() != 0) {
                    sb.append("\r\n");
                }
