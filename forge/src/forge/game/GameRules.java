...
public class GameRules {
    ...
    private boolean uniquePlaneswalker;
    ...
    public boolean planeswalkerIsUnique() {
        return uniquePlaneswalker;
    }

    public void setPlaneswalkerIsUnique(final boolean unique) {
        this.uniquePlaneswalker = unique;
    }
